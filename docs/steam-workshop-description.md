...
[*][b]Your Wonder, not a substitute.[/b] The tile is cleared and the stock Wonder is queued there through the game's own build path. Nothing about Wonders is redefined, so uniqueness, adjacency, cinematics and AI behavior are exactly as they are without the mod.
