...
[b]Preliminary description for the first release, 0.3.0. For Civilization VII 1.5.0.[/b]
...
[*][b]Your citizens are not lost.[/b] Every citizen the cleared buildings housed comes back as a population point, and the game's own Grow City prompt asks where each one settles: a rural tile or a specialist seat, wherever you like.
[*][b]A confirmation before anything is cleared.[/b] It names the buildings by name, says the walls stay, and says how many displaced citizens you will be asked to place. Cancel and nothing happens.
...
[*][b]The Wonder's own rules still decide.[/b] Terrain, biome, adjacent terrain, river, feature, adjacent mountain, adjacent constructible and a required constructible in the settlement are all checked before a tile is offered for a given Wonder. A rule the mod cannot read excludes that Wonder rather than guessing, so it will sometimes offer less than it could and never more.
[*][b]A refusal costs you nothing.[/b] The game will not say whether a Wonder fits a tile until the tile is empty, and it enforces rules no mod can read in advance. If it turns the cleared site down, the mod puts the buildings and walls back, no citizens are displaced, and nothing is lost but the confirmation you pressed.
...
[list]
[*][b]Single player.[/b] Every write is the local player's own, but a live network game has not been tested.
...
[*][b]More Wonder placement rules read from data,[/b] so fewer Wonders are excluded for a tile the game would in fact allow.
[*][b]Multiplayer.[/b]
[/list]
[h2]Source and documentation[/h2]
[list]
[*]Open source on GitHub, with full documentation and the release notes. The links go here at release.
[/list]
[h2]Credits[/h2]
[list]
