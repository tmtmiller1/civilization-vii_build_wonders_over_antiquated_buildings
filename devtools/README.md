...
```
zsh run-harness.sh woobh-game-pb6.js  AugustusExp66.Civ7Save pb6  900 full   # end to end + the real confirm dialog
...
is, and then waits four minutes while you click it and press OK. Synthetic clicks are dropped on this machine
